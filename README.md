...
<p> I'm a Grade 12 student aspiring for a software developer or data engineer job, using the courses available at my school, <a href="https://teh.ocsb.ca/">St. Mother Teresa HS</a> </p>

<hr>

<h2 align=center> Computer Science, Engineering, and Coding Related Achievements </h2>
<ul>
    <li> Completed Grade 12 Engineering Technology (Networking) TEJ4M course </li>
    <li> Completed Grade 12 Computer Science (Java) ICS4U course </li>
    <li> Completed Grade 11 Computer Engineering Technology (Circuits & Hardware) TEJ3M course </li>
    <li> Completed Grade 11 Intro to Computer Science (Python) ICS3U </li>
...
<ul>
    <li>Student Council | Head of Grade Representatives</li>
    <li>Indigenous Student Association | Co President</li>
    <li>Nepean Girls Hockey Association | Team Member</li>
    <li>High School Girls Tackle Football | Team Member</li>
</ul>
